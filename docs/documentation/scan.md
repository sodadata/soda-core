...
Optionally, if you have a **Soda Cloud** account and you have connected it to the soda-sql tool in your environment, Soda SQL automatically pushes the scan output to your Soda Cloud account. You can log in and view the Monitor Results; each row in the Monitor Results table represents the output of one scan.
...
* Learn how to [connect Soda SQL to your Soda Cloud account]({% link get-started/connect_to_cloud.md %}). 