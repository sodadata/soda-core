...
class DiscoverTablesRun:
    def __init__(self, data_source_scan: DataSourceScan, data_source_tables_cfg: DatasourceTablesCfg):
    ...
    def run(self) -> DiscoverTablesResult:
        discover_tables_result: DiscoverTablesResult = DiscoverTablesResult(self.data_source_tables_cfg)
        ...
        row_counts_by_table_name: dict[str, int] = self.data_source.get_row_counts_all_tables(
            include_tables=self.data_source_tables_cfg.include_tables,
            exclude_tables=self.data_source_tables_cfg.exclude_tables,
