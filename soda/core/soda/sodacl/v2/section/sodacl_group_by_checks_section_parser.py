...
from soda.sodacl.v2.section.sodacl_group_by_checks_section import (
...
class SodaClGroupByChecksSectionParser:
    ...
    def parse_group_by_checks_section(
        ...
        return SodaClGroupByChecksSection(section_header_line=antlr_group_by_checks_header.getText())
