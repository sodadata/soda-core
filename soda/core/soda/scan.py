    ...
    def execute(self) -> int:
        ...
        try:
            ...
            if self._configuration.soda_cloud and not isinstance(self._scan_definition_name, str):
                self._logs.error('scan.set_scan_definition_name(...) is not set and it is required to make the Soda Cloud integration work.  For this scan, Soda Cloud will be disabled.')
