...
class ParserLog:
    ...
    def __init__(self, level: ParserLogLevel, message: str, location: ParserLocation | None = None, docs_ref: str | None = None):
    ...
    def to_assertion_summary(self) -> str:
        docs_txt = f' ->(https://github.com/sodadata/data-contracts/blob/main/docs/{self.docs_ref})' if isinstance(self.docs_ref, str) else ''
...
class ParserLogs:
    ...
    def log(self, level: ParserLogLevel, message: str, location: ParserLocation | None = None, docs_ref: str | None = None):
        self.logs.append(
            ParserLog(
                level=level,
                message=message,
