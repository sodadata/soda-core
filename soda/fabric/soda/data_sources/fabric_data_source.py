...
class FabricDataSource(DataSource):
    ...
    SCHEMA_CHECK_TYPES_MAPPING = {"TEXT": ["text", "varchar", "char"]}
    ...
    def __init__(self, logs: Logs, data_source_name: str, data_source_properties: dict):
        ...
        # Credentials
        self.azure_client_id = data_source_properties.get("tenant_client_id")
        self.azure_tenant_id = data_source_properties.get("tenant_id")
    ...
    def build_default_format_expressions(self) -> dict[str, str]:
        ...
        return {
            "email": f"({{expr}} LIKE '%_@__%.%__%' AND {{expr}} NOT LIKE '%@%@%')",
    ...
    def connect(self):
        ...
        try:
            credential = ClientSecretCredential(
                tenant_id=self.azure_tenant_id, client_id=self.azure_client_id, client_secret=self.azure_client_secret
            )
