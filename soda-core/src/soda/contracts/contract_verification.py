...
from soda.contracts.impl.contract_yaml import ContractYaml, CheckYaml
...
class ContractVerification:
    ...
    def __init__(self, contract_verification_builder: ContractVerificationBuilder):
        from soda.contracts.impl.contract_verification_impl import ContractVerificationImpl
...
class CheckResult(ABC):
    ...
    def __init__(self, check_yaml: CheckYaml, outcome: CheckOutcome):
