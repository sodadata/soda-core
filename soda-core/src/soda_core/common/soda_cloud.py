...
from soda_core.data_source.yaml import YamlFile
...
class SodaCloud:
    ...
    def __init__(self, soda_cloud_file: YamlFile):
        ...
        configuration_dict = soda_cloud_file.get_dict() if soda_cloud_file.has_yaml_object() else {}
        soda_cloud_file.parse()
