...
class SodaCloud:
    ...
    def poll_contract_skeleton_generation(
        ...
        * The contract skeleton generation state
        ...
        while datetime.now(tz=timezone.utc) < blocking_timeout:
            ...
            if contract_skeleton_generation_state == ContractSkeletonGenerationState.COMPLETED:
                return True, contract_skeleton_generation_state
            elif contract_skeleton_generation_state == ContractSkeletonGenerationState.FAILED:
                return False, contract_skeleton_generation_state
    ...
    def _get_contract_skeleton_generation_state(
        ...
        if response is None:
            logger.error(f"Failed to poll contract skeleton generation state.")
            return None, None
