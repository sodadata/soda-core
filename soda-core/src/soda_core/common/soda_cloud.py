    ...
    return to_jsonnable(  # type: ignore
        {
            ...
            "defaultDataSource": contract_verification_result.data_source.name if contract_verification_result.data_source else None,
            "defaultDataSourceProperties": {"type": contract_verification_result.data_source.type} if contract_verification_result.data_source else None,
