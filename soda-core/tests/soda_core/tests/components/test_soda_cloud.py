...
from soda_core.tests.helpers.mock_soda_cloud import MockHttpMethod, MockResponse
...
def test_soda_cloud_results(data_source_test_helper: DataSourceTestHelper, env_vars: dict):
    ...
    data_source_test_helper.enable_soda_cloud_mock([MockResponse(status_code=200, json_object={"fileId": "777ggg"})])
    ...
    data_source_test_helper.enable_soda_cloud_mock(
        [
            ...
            MockResponse(
                ...
                json_object={"scanId": "ssscanid", "state": "running"},
            ),
            MockResponse(
