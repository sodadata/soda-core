...
class WarehouseFixture:
    ...
    def create(cls, target: str):
        from tests.common.sql_test_case import TARGET_SNOWFLAKE, TARGET_POSTGRES, TARGET_REDSHIFT, TARGET_ATHENA, \
            TARGET_BIGQUERY, TARGET_HIVE, TARGET_MYSQL, TARGET_SPARK, TARGET_SQLITE
        ...
        elif target == TARGET_SQLITE:
            from tests.warehouses.sqlite_fixture import SQLiteFixture
            return SQLiteFixture(target)
