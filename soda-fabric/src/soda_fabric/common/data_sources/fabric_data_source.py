...
class FabricSqlDialect(SqlServerSqlDialect):
    ...
    def get_contract_type_dict(self) -> dict[str, str]:
        ...
        super_dict[SodaDataTypeNames.TIMESTAMP] = "datetime2"
        super_dict[SodaDataTypeNames.TIMESTAMP_TZ] = "datetime2"
        return super_dict
    ...
    def get_sql_data_type_name_by_soda_data_type_names(self) -> dict[str, str]:
        ...
        super_dict[SodaDataTypeNames.TIMESTAMP] = "datetime2(6)"
        super_dict[SodaDataTypeNames.TIMESTAMP_TZ] = "datetime2(6)"
        return super_dict
